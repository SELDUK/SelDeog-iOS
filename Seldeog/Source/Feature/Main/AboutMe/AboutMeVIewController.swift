...
//        let cv = UICollectionView(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: 700), collectionViewLayout: layout)
//        return cv
//    }()
//    let baseTabBarView = BaseTabBarView()
//    var featureList: [UserCharacterComment] = []
//
...
//}
//
//extension AboutMeViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, CommentButtonProtocol {
//
//    func modifyComment(serverIndex: Int, cellIndex: Int) {
//        var tag1 = ""
//        var tag2 = ""
...
//        view.addSubviews(titleLabel, characterNameLabel, myCharacterImageView, writeButton, lineView, collectionView, baseTabBarView)
//    }
//
